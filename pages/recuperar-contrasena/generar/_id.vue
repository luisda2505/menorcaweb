                ...
                <div class="row align-items-center h-100">
                  ...
                  <div class="col-12">
                    ...
                    <div class="wrap">
                        ...
                        <p class="info">Genera una nueva contraseña para tu cuenta:</p>
                        ...
                        <div class="d-flex align-items-center" style="max-width:200px;">
                          <button @click="createAccount" class="btn btn-green" :disabled="loading">Actualizar contraseña</button>
	...
	methods: {
      async  createAccount() {
        ...
        if (!regex.test(this.password)) {
            this.errorMessage = "Las contraseña debe contener 8 caracteres como mínimo y una letra en mayúscula.";
            return;
        }
